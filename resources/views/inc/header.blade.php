    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
            <div class="flex justify-start lg:w-0 lg:flex-1">
                <a href="{{ route('home') }}">
                    <span class="sr-only">MullerSoft</span>
            ...
            <nav class="hidden md:flex space-x-10">
                        ...
                        <div x-show="open" @click.outside="open = false"
                            ...
                            <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                <a href="#" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                                    ...
                                    <div class="ml-4">
                                        <p class="text-base font-medium text-gray-900">Servicios Hardware</p>
                                        <p class="mt-1 text-sm text-gray-500">
                                            Mantenimiento Correctivo, Mantenimiento Preventivo, Reemplazo de partes en
                                            campo y ventas de componentes.
                                        </p>
                                    </div>
                                </a>
                                ...
                                <a href="#" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                                    ...
                                    <div class="ml-4">
                                        <p class="text-base font-medium text-gray-900">Servicios de Software</p>
                ...
                <a href="{{ route('team') }}" class="text-base font-medium text-gray-500 hover:text-gray-900"> Nuestro
                    Equipo </a>
                <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900"> Sobre Nosotros </a>
...
-->
    <div class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
        <div x-data="{ open: true }"
            ...
            <div x-show="open" @click.outside="open = false" class="pt-5 pb-6 px-5">
            ...
            <div class="py-6 px-5 space-y-6">
                <div class="grid grid-cols-2 gap-y-4 gap-x-8">
                    <a href="#" class="text-base font-medium text-gray-900 hover:text-gray-700"> Nuestro Equipo </a>

                    <a href="#" class="text-base font-medium text-gray-900 hover:text-gray-700"> Sobre Nostros </a>
